...
export function GoogleApiProvider({ clientId, children }) {
    ...
    function configure(options, state) {
        var _a, _b, _c;
        const modules = ((_a = options.modules) !== null && _a !== void 0 ? _a : []).concat(((_b = options.discoveryDocs) === null || _b === void 0 ? void 0 : _b.length) ? ['client'] : [], ((_c = options.scopes) === null || _c === void 0 ? void 0 : _c.length) ? ['auth2'] : []);
        if (gapi) {
            return doConfigure(gapi, clientId, requested, loading, done, Object.assign(Object.assign({}, options), { modules }), state);
        }
    }
...
function doConfigure(gapi, clientId, requested, loading, done, options, state) {
    ...
    function init(options, state) {
        ...
        const auth = (_a = gapi.auth2) === null || _a === void 0 ? void 0 : _a.getAuthInstance();
        const missingScopes = (() => {
            var _a, _b;
            if (!scopes.length || !auth) {
                return scopes;
            }
            const grantedScopes = ((_b = (_a = auth.currentUser.get()) === null || _a === void 0 ? void 0 : _a.getGrantedScopes()) !== null && _b !== void 0 ? _b : '').split(' ');
    ...
    function doInitScopes(options, state) {
        ...
        if (loadScopes.length && (gapi === null || gapi === void 0 ? void 0 : gapi.auth2)) {
            ...
            const auth = (_a = gapi.auth2.getAuthInstance()) !== null && _a !== void 0 ? _a : gapi.auth2.init({
                client_id: clientId,
